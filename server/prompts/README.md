# Server Prompt Assets

Back to the main docs hub: [Documentation Hub](../../docs/README.md)

These prompt files support itinerary and content-generation flows on the server.
...
- [Itinerary Comprehensiveness — Phased Coding Plan](itinerary-improvements-coding-plan.md) — LLM execution plan implementing itinerary-improvements.md in dependency order, with performance/cost/caching/test-coverage requirements per phase
...
- [GetYourGuide Phased Coding Plan](getyourguide-coding-plan.md) — LLM execution plan covering API limits, caching, performance, testing, UI, rollouts, and clean fallbacks
