...
|---|---|---|
| Local (`isLocalEnv()`) | `server/data/ai-capture/itinerary/YYYY-MM-DD/<jobId>/<stage>.json` | Local disk, `server/data` is already `.gitignore`d and excluded from EAS/deploy per `.easignore` |
