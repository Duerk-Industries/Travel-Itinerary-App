...
/**
 * Official unmodified Google "G" mark. Per Google's identity branding
 * guidelines (developers.google.com/identity/branding-guidelines) the
 * four-color logo must be reproduced exactly as specified — no recoloring,
 * skewing, or substituting a single-color version.
 */
